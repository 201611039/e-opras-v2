<div>
    ...
    <div class="row">
        <div class="form-group @error('directorate_id') has-error @enderror col-sm-6">
            <div class="col-sm-12">
                ...
                <select disabled type="text" name="directorate_id" class="form-control select2">
        ...
        <div class="form-group @error('station_id') has-error @enderror col-sm-6">
            <div class="col-sm-12">
               ...
               <select disabled type="text" name="station_id" class="form-control select2">
        ...
        <div class="form-group @error('academic_qualification') has-error @enderror col-sm-12">
            ...
            <div class="col-sm-8 center">
               <label class=" control-label">Academic Qualification</label>
                <input disabled type="text" name="academic_qualification" value="{{ old('academic_qualification')??$personalInformation->academic_qualification }}" class="form-control">
    ...
    <div class="row">
        <div class="form-group @error('post_id') has-error @enderror col-sm-6">
            <div class="col-sm-12">
               ...
               <select disabled type="text" name="post_id" class="form-control select2">
        ...
        <div class="form-group @error('substantive_post') has-error @enderror col-sm-6">
            ...
            <label class="control-label">Substative Post <span class="text-danger">(Optional)</span></label>
                <input disabled type="text" name="substantive_post" value="{{ old('substantive_post')??$personalInformation->substantive_post }}" class="form-control">
    ...
    <div class="row">
        ...
        <div class="form-group @error('salary_scale') has-error @enderror col-sm-4">
          ...
          <label class="control-label">Salary scale</label>
                <input disabled type="text" name="salary_scale" value="{{ old('salary_scale')??$personalInformation->salary_scale }}" class="form-control">
                @error('salary_scale')
                    <span class="text-danger small">
                        {{ $message }}
                    </span>
        ...
        <div class="form-group @error('period') has-error @enderror col-sm-8">
            ...
            <label class="control-label">Period served under Present Supervisor (Months) <br><small></small></label>
                <input disabled type="number" name="period" value="{{ old('period')??$personalInformation->period }}" class="form-control">
                @error('period')
                    <span class="text-danger small">
                        {{ $message }}
                    </span>
            ...
            <div style="padding-left: 16px;" class="form-group @error('first_appointment_present_post') has-error @enderror">
                <div class="" id="data_3">
                    ...
                    <div class="col-sm-10 input-group date">
                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input disabled type="text" class="form-control" name="first_appointment_present_post" value="{{ old('first_appointment_present_post')??(isset($personalInformation->first_appointment_present_post)?$personalInformation->first_appointment_present_post->format('d/m/Y'):'') }}">
            ...
            <div class="form-group @error('supervisor_id') has-error @enderror col-sm-12">
                ...
                <div class="col-sm-8 center">
                   <label class=" control-label">Supervisor</label>
                    <select disabled type="text" name="supervisor_id" class="form-control select2">
    ...
    <div class="row">
        <div style="padding-left: 30px;" class="form-group col-sm-6">
            ...
            <select disabled type="text" name="term_of_service" value="{{ old('term_of_service')??$personalInformation->term_of_service }}" class="form-control select2">
